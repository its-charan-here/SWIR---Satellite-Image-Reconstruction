...
from utils import random_bbox, bbox2mask, local_patch, brush_stroke_mask
from utils import resize_mask_like, contextual_attention


logger = logging.getLogger()


class GAN_Reconstruction(Model):
    def __init__(self):
        super().__init__('GAN_Reconstruction')
    ...
    def build_infer_graph(self, FLAGS, batch_data, bbox=None, name='val'):
        ...
        # print("Applying mask and reconstruct")
        batch_complete = batch_predicted*mask + batch_incomplete*(1.-mask)
    ...
    def build_server_graph(self, FLAGS, batch_data, reuse=False, is_training=False):
        ...
        # apply mask and reconstruct
        # print("Applying Mask for reconstruction")
